...
local function defs_data_set(skill, tbl)
  if defs_data[skill] then
    local existingData = defs_data[skill]
    ...
    defs_data:set(skill, tbl)
  end
end

  defs_data_set("softfocus", { type = "general",
    mana = "lots",
  ...
  defs_data_set("metawake", { type = "general",
  ...
  defs_data_set("mass", { type = "general",
  ...
  defs_data_set("treewatch", { type = "general",
    mana = "little",
  ...
  defs_data_set("groundwatch", { type = "general",
    mana = "little",
  ...
  defs_data_set("alertness", { type = "general",
    mana = "little",
  ...
  defs_data_set("curseward", { type = "general",
  ...
  defs_data_set("bell", { type = "general",
  ...
  defs_data_set("cloak", { type = "general",
  ...
  defs_data_set("favour", { nodef = true,
  ...
  defs_data_set("telesense", { type = "general",
    mana = "little",
  ...
  defs_data_set("hypersight", { type = "general",
    mana = "little",
  ...
  defs_data_set("parry", { nodef = true,
    ondef = function ()
  ...
  defs_data_set("nightsight", { type = "general",
  ...
  defs_data_set("block", { type = "general",
  ...
  defs_data_set("vigilance", { type = "general",
  ...
  defs_data_set("satiation", { type = "general",
    invisibledef = true,
  ...
  defs_data_set("clinging", { type = "general",
  ...
  defs_data_set("selfishness", { type = "general", def = "You are feeling quite selfish.",
    onenable = function (mode, newdef, whereto, echoback)
  ...
  defs_data_set("flying", { nodef = true,
    def = "You are soaring high above the ground." })
  defs_data_set("starburst", { nodef = true,
    def = "You are walking with the grace of the stars." })
  defs_data_set("chameleon", { nodef = true,
    ondef = function () return "("..matches[2]..")" end,
    defr = [[^You are assuming the identity of (\w+)\.$]]})
  defs_data_set("insomnia", { type = "general",
  ...
  defs_data_set("kola", { type = "general",
    def = "You are feeling extremely energetic." })
  defs_data_set("extra crits", { nodef = true,
    def = "You are surrounded by a lucky green aura."})
  defs_data_set("rebounding", { type = "general",
  ...
  defs_data_set("lyre", { type = "general",
  ...
  defs_data_set("frost", { type = "general", def = "You are tempered against fire damage.",
    on = "A chill runs over your icy skin.",
    off = "Forks of flame lick against your skin, melting away your protection against fire."})
  defs_data_set("venom", { type = "general", def = "Your resistance to damage by poison has been increased.",
    on = "You feel a momentary dizziness as your resistance to damage by poison increases."})
  defs_data_set("levitation", { type = "general", def = "You are walking on a small cushion of air.",
  ...
  defs_data_set("shield", { type = "general",
  ...
  defs_data_set("riding", { type = "general",
...
#if not skills.groves then
  defs_data_set("grove vigour", { nodef = true,
    def = "You are bathed in an aura of radiant sunlight."})
#end

-- Dragoncraft: everyone gets it
  defs_data_set("dragonform", { type = "dragoncraft",
  ...
  defs_data_set("dragonarmour", { type = "dragoncraft",
  ...
  defs_data_set("dragonbreath", { type = "dragoncraft",
    specialskip = function() return not defc.dragonform end,
  ...
  defs_data_set("deathaura", { type = "necromancy",
  ...
  defs_data_set("shroud", { type = "necromancy",
  ...
  defs_data_set("lifevision", { type = "necromancy",
  ...
  defs_data_set("putrefaction", { type = "necromancy",
  ...
  defs_data_set("vengeance", { type = "necromancy",
    staysindragon = true,
    offline_defence = true,
  ...
  defs_data_set("sturdiness", { type = "chivalry",
  ...
  defs_data_set("grip", { type = "chivalry",
  ...
  defs_data_set("mastery", { type = "chivalry",
  ...
  defs_data_set("deflect", { type = "weaponmastery",
  ...
  defs_data_set("weathering", { type = "shindo",
    on = "A brief shiver runs through your body.",
    def = "Your body is weathering the storm of life a little better."})
  defs_data_set("sturdiness", { type = "shindo",
    on = "You cross your arms, standing firm and resolute.",
    def = "You are standing firm against attempts to move you.",
    off = "You cease to stand firm against attempts to move you." })
  defs_data_set("toughness", { type = "shindo",
    def = "Your skin is toughened.",
    on = "Flexing your muscles, you concentrate on forcing unnatural toughness over the surface of your skin."})
  defs_data_set("clarity", { type = "shindo",
  ...
  defs_data_set("mindnet", { type = "shindo",
  ...
  defs_data_set("constitution", { type = "shindo",
    def = "You are using your superior constitution to prevent nausea.",
  ...
  defs_data_set("waterwalk", { type = "shindo",
  ...
  defs_data_set("shintrance", { type = "shindo",
  ...
  defs_data_set("consciousness", { type = "shindo",
  ...
  defs_data_set("bind", { type = "shindo",
  ...
  defs_data_set("projectiles", { type = "shindo",
  ...
  defs_data_set("dodging", { type = "shindo",
  ...
  defs_data_set("grip", { type = "shindo",
    on = {"You concentrate on gripping tightly with your hands.", "You are already tightly gripping with your hands."},
    def = "Your hands are gripping your wielded items tightly.",
    off = "You relax your grip."})
  defs_data_set("immunity", { type = "shindo",
  ...
  defs_data_set("retaliationstrike", { type = "twoarts",
  ...
  defs_data_set("doya", { type = "twoarts",
  ...
  defs_data_set("thyr", { type = "twoarts",
    off = {"You adopt a neutral stance.", "You are not in any stance, Warrior."},
  ...
  defs_data_set("mir", { type = "twoarts",
    off = {"You adopt a neutral stance.", "You are not in any stance, Warrior."},
  ...
  defs_data_set("arash", { type = "twoarts",
    off = {"You adopt a neutral stance.", "You are not in any stance, Warrior."},
  ...
  defs_data_set("sanya", { type = "twoarts",
    off = {"You adopt a neutral stance.", "You are not in any stance, Warrior."},
  ...
  defs_data_set("phase", { type = "subterfuge",
  ...
  defs_data_set("hiding", { type = "subterfuge",
  ...
  defs_data_set("scales", { type = "subterfuge",
  ...
  defs_data_set("pacing", { type = "subterfuge",
  ...
  defs_data_set("bask", { type = "subterfuge",
  ...
  defs_data_set("listen", { type = "subterfuge",
  ...
  defs_data_set("weaving", { type = "subterfuge",
    mana = "lots",
  ...
  defs_data_set("cloaking", { type = "subterfuge",
  ...
  defs_data_set("ghost", { type = "subterfuge",
    ...
    offr = [[^\w+ points a finger at you and you feel anti-magic sweep over you\.$]], })
  defs_data_set("secondsight", { type = "subterfuge",
  ...
  defs_data_set("drunkensailor", { type = "swashbuckling",
  ...
  defs_data_set("arrowcatch", { type = "swashbuckling",
    mana = "lots",
  ...
  defs_data_set("balancing", { type = "swashbuckling",
    mana = "lots",
  ...
  defs_data_set("acrobatics", { type = "swashbuckling",
  ...
  defs_data_set("dodging", { type = "swashbuckling",
    on = {"You resolve to keep an eye on the skies for danger.", "You are already watching the skies."},
    def = "You are watching the skies for danger.",
    off = "You cease watching the skies."})
  defs_data_set("grip", { type = "swashbuckling",
    on = {"You concentrate on gripping tightly with your hands.", "You are already tightly gripping with your hands."},
    def = "Your hands are gripping your wielded items tightly.",
    off = "You relax your grip."})
  defs_data_set("heartsfury", { type = "swashbuckling",
  ...
  defs_data_set("lay", { type = "voicecraft",
  ...
  defs_data_set("tune", { type = "voicecraft",
  ...
  defs_data_set("songbird", { type = "voicecraft",
  ...
  defs_data_set("aria", { type = "voicecraft",
  ...
  defs_data_set("lament", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("anthem", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("harmonius", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("contradanse", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("paxmusicalis", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("gigue", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("bagatelle", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("partita", {type = "harmonics", custom_def_type = "harmonic",
    on = "Delicate and precise, you take up a Partita.",
    off = "The Partita ends without fanfare, precisely as it began."})
  defs_data_set("berceuse", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("continuo", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("wassail", {type = "harmonics", custom_def_type = "harmonic",
    on = "The Wassail's first notes stir and strengthen you.",
    off = "The Wassail trails slowly off, coming to a melancholy conclusion."})
  defs_data_set("canticle", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("reel", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("hallelujah", {type = "harmonics", custom_def_type = "harmonic",
  ...
  defs_data_set("inspiration", { type = "devotion",
  ...
  defs_data_set("bliss", { type = "devotion",
    staysindragon = true,
    ...
    invisibledef = true })
  defs_data_set("bloodsworn", { type = "devotion",
  ...
  defs_data_set("mace", { type = "spirituality",
    invisibledef = true})
  defs_data_set("heresy", { type = "spirituality",
  ...
  defs_data_set("summon", { type = "spirituality",
    def = "You are regenerating endurance at an increased rate.",
  ...
  defs_data_set("empathy", { type = "spirituality",
  ...
  defs_data_set("care", { type = "spirituality",
    specialskip = function() return not defc.summon end,
  ...
  defs_data_set("watch", { type = "spirituality",
  ...
  defs_data_set("affinity", { type = "metamorphosis",
  ...
  defs_data_set("bonding", { type = "metamorphosis",
  ...
  defs_data_set("elusiveness", { type = "metamorphosis",
  ...
  defs_data_set("flame", { type = "metamorphosis",
  ...
  defs_data_set("lyre", { type = "metamorphosis",
  ...
  -- defs_data_set("nightsight", { type = "metamorphosis",
  ...
  defs_data_set("rest", { type = "metamorphosis",
  ...
  defs_data_set("temperance", { type = "metamorphosis",
  ...
  defs_data_set("vitality", { type = "metamorphosis",
  ...
  defs_data_set("squirrel", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
  ...
  defs_data_set("wildcat", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("wolf", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("turtle", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("jackdaw", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("cheetah", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("owl", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("hyena", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("condor", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("gopher", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("sloth", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
...
#end
  defs_data_set("bear", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("nightingale", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("elephant", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("wolverine", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
...
#end
  defs_data_set("eagle", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("gorilla", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("icewyrm", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("hydra", { type = "metamorphosis",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"squirrel", "wildcat", "wolf", "turtle", "jackdaw", "cheetah", "owl", "hyena", "condor", "gopher", "sloth", "basilisk", "bear", "nightingale", "elephant", "wolverine", "jaguar", "eagle", "gorilla", "icewyrm", "wyvern", "hydra", "flame"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("astralvision", { type = "occultism",
    ...
    def = "You have enhanced your vision to be able to see traces of lifeforce." })
  defs_data_set("distortedaura", { type = "occultism",
  ...
  defs_data_set("tentacles", { type = "occultism",
  ...
  defs_data_set("devilmark", { type = "occultism",
  ...
  defs_data_set("astralform", { type = "occultism",
  ...
  defs_data_set("heartstone", { type = "occultism",
    ...
    invisibledef = true })
  defs_data_set("simulacrum", { type = "occultism",
    ...
    invisibledef = true })
  defs_data_set("transmogrify", { type = "occultism",
      staysindragon = true,
...
#if skills.tarot then
  defs_data_set("devil", { type = "tarot",
  ...
  defs_data_set("arctar", { type = "domination",
  ...
  defs_data_set("golgotha", { type = "domination",
  ...
  defs_data_set("simultaneity", {
    type = "healing",
    custom_def_type = "channel"
  })
  defs_data_set("bindall", {
    type = "healing",
    custom_def_type = "channel"
  })
  defs_data_set("fortifyall", {
    type = "healing",
    custom_def_type = "channel"
  })
  defs_data_set("air", {
  ...
  defs_data_set("arrowcatch", { type = "pranks",
    mana = "lots",
    on = {"You have begun to look for arrows to pluck from the air.", "You already have arrowcatching on."},
    def = "You are attempting to pluck arrows from the air.",
    off = "You've turned off arrowcatching."})
  defs_data_set("balancing", { type = "pranks",
    mana = "lots",
    on = {"You move onto the balls of your feet and begin to concentrate on balance.", "You're already balancing."},
    def = "You are balancing on the balls of your feet.",
    off = "You cease to balance on the balls of your feet."})
  defs_data_set("acrobatics", { type = "pranks",
    on = {"You begin leaping and bouncing about, making it more difficult to hit you.", "You are already bouncing around acrobatically."},
    def = "You are bouncing around acrobatically.",
    off = "You cease your acrobatic leaping and bouncing."})
  defs_data_set("slipperiness", { type = "pranks",
  ...
  defs_data_set("grip", { type = "puppetry",
    on = {"You concentrate on gripping tightly with your hands.", "You are already tightly gripping with your hands."},
    def = "Your hands are gripping your wielded items tightly.",
    off = "You relax your grip."})
#end
  ...
  defs_data_set("swiftcurse", { type = "curses",
  ...
  defs_data_set("weathering", { type = "kaido",
    on = "A brief shiver runs through your body.",
    def = "Your body is weathering the storm of life a little better."})
  defs_data_set("resistance", { type = "kaido",
    on = "You call aloud and feel an aura of resistance shroud itself silently about you.",
    def = "You are resisting magical damage."})
  defs_data_set("numb", { type = "kaido",
  ...
  defs_data_set("regeneration", { type = "kaido",
  ...
  defs_data_set("boosting", { type = "kaido",
    onenable = function (mode, newdef, whereto, echoback)
  ...
  defs_data_set("kaiboost", { type = "kaido",
  ...
  defs_data_set("toughness", { type = "kaido",
    on = "Flexing your muscles, you concentrate on forcing unnatural toughness over the surface of your skin.",
    def = "Your skin is toughened."})
  -- disabled, better be general for dragons to work
  -- defs_data_set("nightsight", { type = "kaido",
  --   def = "Your vision is heightened to see in the dark.",
  --   on = {"Your vision sharpens with light as you gain night sight.", "Your eyes already have the benefit of night sight."},
  --   off = {"Your eyes lose the benefit of night sight.", "Your eyes cannot lose the benefit of night sight, since they do not already have it!"}})
  defs_data_set("projectiles", { type = "kaido",
    mana = "lots",
    def = "You are alert to incoming projectiles.",
    off = {"You cease your watch for projectiles.", "You are not watching for projectiles."},
    on = "You look about sharply, poised to avoid all incoming projectiles."})
  defs_data_set("trance", { type = "kaido",
    mana = "lots",
  ...
  defs_data_set("dodging", { type = "kaido",
    mana = "lots",
    on = "You resolve to keep an eye on the skies for danger.",
    def = "You are watching the skies for danger.",
    off = {"You are not using Shindo Dodging.", "You cease watching the skies."}})
  defs_data_set("constitution", { type = "kaido",
    def = "You are using your superior constitution to prevent nausea.",
    on = {"You clench the muscles in your stomach, determined to assert your superior constitution.", "You are using your superior constitution to prevent nausea."}})
  defs_data_set("splitmind", { type = "kaido",
  ...
  defs_data_set("consciousness", { type = "kaido",
    def = "You are maintaining consciousness at all times.",
    off = {"You are not maintaining consciousness.", "You will no longer concentrate on retaining full consciousness."},
    on = {"You are already maintaining consciousness.", "You will remain conscious at all times."}})
  defs_data_set("sturdiness", { type = "kaido",
    on = "You cross your arms, standing firm and resolute.",
    def = "You are standing firm against attempts to move you.",
    off = "You cease to stand firm against attempts to move you."})
  defs_data_set("vitality", { type = "kaido",
    on = {"Your body is already aglow with vitality.", "Your body positively glows with health and vitality."},
    def = "You will call upon your fortitude in need.",
  ...
  defs_data_set("immunity", { type = "kaido",
    on = "You close your eyes and grit your teeth, feeling the heat of the blood pumping through your veins.",
    off = "You cease concentrating on immunity."})
#end

#if skills.tekura then
  defs_data_set("guarding", { nodef = true,
    ondef = function ()
      local t = sps.parry_currently
      for limb, _ in pairs(t) do t[limb] = false end
      t[matches[2]] = true
  ...
  defs_data_set("bodyblock", { type = "tekura",
    mana = "lots",
  ...
  defs_data_set("pinchblock", { type = "tekura",
    mana = "lots",
  ...
  defs_data_set("evadeblock", { type = "tekura",
    mana = "lots",
  ...
  defs_data_set("horse", { type = "tekura",
    onenable = function (mode, newdef, whereto, echoback)
  ...
  defs_data_set("eagle", { type = "tekura",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"horse", "eagle", "cat", "bear", "rat", "scorpion", "dragon"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("bear", { type = "tekura",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"horse", "eagle", "cat", "bear", "rat", "scorpion", "dragon"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("scorpion", { type = "tekura",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"horse", "eagle", "cat", "bear", "rat", "scorpion", "dragon"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("dragon", { type = "tekura",
    onenable = function (mode, newdef, whereto, echoback)
      for _, morph in ipairs{"horse", "eagle", "cat", "bear", "rat", "scorpion", "dragon"} do
        if morph ~= newdef and svo["def"..whereto][mode][morph] then
          svo["def"..whereto][mode][morph] = false
  ...
  defs_data_set("mindtelesense", { type = "telepathy",
    mana = "lots",
  ...
  defs_data_set("mindcloak", { type = "telepathy",
  ...
  defs_data_set("mindnet", { type = "telepathy",
    ...
    mana = "little",
    def = "You have cast a mindnet over the local area."})
  defs_data_set("hypersense", { type = "telepathy",
    mana = "lots",
  ...
  defs_data_set("barkskin", { type = "woodlore",
  ...
  defs_data_set("evasion", { type = "woodlore",
  ...
  defs_data_set("firstaid", { type = "woodlore",
  ...
  defs_data_set("fleetness", { type = "woodlore",
  ...
  defs_data_set("barkskin", { type = "propagation",
    on = {"You concentrate for a moment, and your skin becomes rough and thick like tree bark.", "Your skin is already covered in protective bark.", "Your skin is already as tough as bark."},
    def = "Your skin is hard and tough like the bark of an oak tree."})
  defs_data_set("viridian", { type = "propagation",
  ...
  defs_data_set("panacea", { type = "groves",
  ...
  defs_data_set("vigour", { type = "groves",
    ...
    on_only = "You find your sunlight reserves too low to attempt that.",
    def = "You are bathed in an aura of radiant sunlight."})
  defs_data_set("flail", { type = "groves",
  ...
  defs_data_set("wildgrowth", { type = "groves",
  ...
  defs_data_set("dampening", { type = "groves",
    invisibledef = true,
    on_only = "You find your sunlight reserves too low to attempt that.",
  ...
  defs_data_set("snowstorm", { type = "groves",
    invisibledef = true,
    on_only = "You find your sunlight reserves too low to attempt that.",
  ...
  defs_data_set("roots", { type = "groves",
    invisibledef = true,
    on_only = "You find your sunlight reserves too low to attempt that.",
  ...
  defs_data_set("concealment", { type = "groves",
    invisibledef = true,
  ...
  defs_data_set("screen", { type = "groves",
    invisibledef = true,
  ...
  defs_data_set("lyre", { type = "groves",
    on_only = "You find your sunlight reserves too low to attempt that.",
    specialskip = function() return not conf.lyre end,
    availableindragon = true,
    onenable = function (mode, newdef, whereto, echoback)
    ...
    def = "You are standing within a prismatic barrier.",
    off = {"Your prismatic barrier dissolves into nothing.", "The stream hits your prismatic barrier, shattering it.", "The breath weapon rips apart your prismatic barrier.", "The breath weapon rips through both your shield and prismatic barrier.", "The spear shatters your prismatic barrier."}})
  defs_data_set("swarm", { type = "groves",
    invisibledef = true,
  ...
  defs_data_set("sulphur", { type = "alchemy",
  ...
  defs_data_set("mercury", { type = "alchemy",
  ...
  defs_data_set("extispicy", { type = "alchemy",
  ...
  defs_data_set("empower", { type = "alchemy",
    on = {
  ...
  defs_data_set("scout", { type = "skirmishing",
...
-- signals for shadowcloak tracking
  ...
  defs_data_set("blur", { type = "aeonics",
    def = "Travelling the world more quickly due to time dilation."
  })
  defs_data_set("dilation", { type = "aeonics",
    onenable = function (mode, newdef, whereto, echoback)
      if svo["def"..whereto][mode].breath then
        svo["def"..whereto][mode].breath = false
        if echoback then echof("Removed breath from %s, it's incompatible with %s to have simultaneously up.", whereto, newdef) end
  ...
  for k,v in defs_data:iter() do
    ...
    if v.type then
      if type(v.type) == "string" then
        ...
        for _, category in ipairs(v.type) do
          defences.def_types[category] = defences.def_types[category] or {}
          defences.def_types[category][#defences.def_types[category]+1] = k
        end
      end
    end
    ...
    if v.type then
      if type(v.type) == "string" then
        ...
        for _, category in ipairs(v.type) do
          sk.ignored_defences[category] = sk.ignored_defences[category] or {status = false, t = {}}
          sk.ignored_defences[category].t[k] = sk.ignored_defences[category].t[k] or false
          sk.ignored_defences_map[k] = category
        end
      end
    end
  end
...
function sk.have_defup_defs()
  local waitingon = {}
  local function calcSpecialSkip(deft)
    local ret = false
    if type(deft.specialskip) == "function" then
