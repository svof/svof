...
<<<<<<< Updated upstream:raw-svo.defs.lua
defences.def_types = {}
...
=======
defences.def_types = {} or defences.def_types

-- the list from 'def'
defences.def_def_list = {} or defences.def_def_list
defences.defup_timer = createStopWatch() or defences.defup_timer
>>>>>>> Stashed changes:svo (alias and defence functions).xml
