...
#for _, aff in ipairs({"unweavingbody", "unweavingmind", "unweavingspirit", "pressure", "cholerichumour", "melancholichumour", "phlegmatichumour", "sanguinehumour", "bleeding", "skullfractures", "crackedribs", "wristfractures", "torntendons"}) do
