...
sys.update_people_labels = function ()
  ...
  if not s then
    echoLink("(e!)", [[echo([=[The problem was: ]]..m..[[]=])]], 'Oy - there was a problem with the peopletracker. Click on this link and submit a bug report with what it says.')
  end
...
if svo.systemloaded then svo.loader.peopletracker() end