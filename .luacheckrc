  ...
  read_globals = {
    svo = {
      fields = {
        ...
        "will_take_balance", "newbals", "echon", "toboolean", "cc", "doadd",
          rf_refilling       = { read_only = false, other_fields = true },
          rf_arties          = { read_only = false, other_fields = true },
          rf_debug           = { read_only = false },
          missing_arty       = { read_only = false },
          rf_currenttrans    = { read_only = false },
          rf_fillpot         = { read_only = false },
          rf_previousorder   = { read_only = false },
          rf_boilpot         = { read_only = false },
          rf_magichappened   = { read_only = false },
          rf_fillnext        = { read_only = false },
          rf_fillarty        = { read_only = false },
          rf_cancel          = { read_only = false },
          rf_refill          = { read_only = false },
          rf_nextpotion      = { read_only = false },
          rf_undopot         = { read_only = false },
          rf_missingstuff    = { read_only = false },
          rf_transrefiller   = { read_only = false },
          rf_transtoxicology = { read_only = false },
          rf_wait_to_boil    = { read_only = false },
          rf_temptrigger     = { read_only = false },
      }
    }
  }
}

files["raw-svo.priestreport.lua"] = {
  read_globals = {
    "mmp",
    svo = {
      fields = {
        "actionclear", "actionfinished", "actions", "actions_performed",
        "addaffdict", "addbalanceful", "addbalanceless", "affl", "affs", "affsp",
        "aiprompt", "app", "apply", "assert", "balanceless", "bals", "bals_in_use",
        "basictableindexdiff", "bottomprompt", "can_usemana", "check_dofree",
        "check_generics", "check_sp_satisfied", "checkaction", "checkany",
        "clear_balance_prios", "clear_sync_prios", "cn", "cnrl", "codepaste",
        "concatand", "conf", "conf_printinstallhint", "config", "contains",
        "containsbyname", "convert_string", "count_until_last_paragraph", "cp",
        "cpp", "danaeusaffs", "debugf", "deepcopy", "defc", "defdefup", "defences",
        "defkeepup", "defs", "defs_data", "defupfinish", "deleteAllP",
        "deleteLineP", "dict", "dict_balanceful", "dict_balanceful_def",
        "dict_balanceless", "dict_balanceless_def", "dict_herb", "dict_misc",
        "dict_misc_def", "dict_purgative", "dict_salve_def", "dict_setup",
        "dict_smoke_def", "dict_validate", "doaction", "doaddfree", "doingaction",
        "donext", "dont_unpause_login", "dragonheal", "eat", "echoafftime", "echof",
        "echofn", "echos", "echosd", "empty", "enabledclasses", "enabledskills",
        "endbalancewatch", "errorf", "es_categories", "es_potions", "es_shortnames",
        "es_shortnamesr", "fancysend", "fancysendall", "fillpipe",
        "find_until_last_paragraph", "findbybal", "findbybals", "fitness",
        "force_send", "fullstats", "gaffl", "gdefc", "getBoundary",
        "getDefaultColor", "getDefaultColorNums", "getHighestKey", "getping",
        "gettreeableaffs", "green", "haveskillset", "ignore", "ignore_illusion",
        "index_map", "inra", "install", "intlen", "itf", "keystolist", "killaction",
        "knownskills", "lastlit", "lastpromptnumber", "life", "lifep", "lifevision",
        "logging_in", "longeststring", "lostbal_dragonheal", "lostbal_fitness",
        "lostbal_focus", "lostbal_healing", "lostbal_herb", "lostbal_moss",
        "lostbal_purgative", "lostbal_rage", "lostbal_salve", "lostbal_shrugging",
        "lostbal_sip", "lostbal_smoke", "lostbal_tree", "lostbal_voice",
        "make_gnomes_work", "make_prio_table", "make_prio_tablef",
        "make_sync_prio_table", "make_sync_prio_tablef", "me",
        "mm_create_riftlabel", "nemesisaffs", "ofs", "oldsend", "oneconcat",
        "oneconcatwithval", "paragraph_length", "pflags", "phpTable",
        "pipe_assignid", "pipes", "pl", "prio", "prio_swap", "process_defs",
        "promptcount", "prompttrigger", "rage", "red", "reset", "restore", "rift",
        "riftlabel", "ripairs", "rmaff", "sacid", "safeconcat", "scragaffs", "send",
        "send_in_the_gnomes", "sendc", "sendcuring", "serverignore",
        "setdefaultprompt", "setignore", "setserverignore", "setupserverside",
        "show_info", "showprompt", "shrugging", "signals", "sip", "sk", "sp",
        "sp_checksp", "sp_config", "sp_limbs", "sps", "startbalancewatch", "stats",
        "swapped_asthma", "syncdelay", "sys", "systemloaded", "tablesave",
        "tntf_set", "tree", "unsetignore", "unsetserverignore", "update",
        "updateaffcount", "updateloggingconfig", "usingbal", "vaff", "valid",
        "valid_sync_action", "version", "vm", "wait_tbl", "watch",
        "will_take_balance", "newbals", "echon", "toboolean", "cc",
          rooms_to_announce  = { read_only = false, other_fields = true },
          tracing            = { read_only = false },
          recently_announced = { read_only = false },
          angel_trace        = { read_only = false },
          trace              = { read_only = false },
...
files["raw-svo.priesthealing.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "actionclear", "actionfinished", "actions", "actions_performed",
        ...
        "updateaffcount", "updateloggingconfig", "usingbal", "vaff", "valid",
        "valid_sync_action", "version", "vm", "wait_tbl", "watch",
        "will_take_balance", "newbals", "echon", "toboolean",
          ph_diag              = { read_only = false },
          healothersaff        = { read_only = false },
          currently_diagnosing = { read_only = false, other_fields = true },
      }
    }
  }
}

files["raw-svo.namedb.lua"] = {
  read_globals = {
    "seconds2human",
    ...
    svo = {
      fields = {
        ...
        "valid_sync_action", "version", "vm", "wait_tbl", "watch",
        "will_take_balance", "newbals", "echon", "toboolean",
          signals        = { read_only = false, other_fields = true },
      }
    }
  }
}

files["raw-svo.inker.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "actionclear", "actionfinished", "actions", "actions_performed",
        ...
        "updateaffcount", "updateloggingconfig", "usingbal", "vaff", "valid",
        "valid_sync_action", "version", "vm", "wait_tbl", "watch",
        "will_take_balance", "newbals", "echon",
          ti_version        = { read_only = false },
          ti_cantink        = { read_only = false },
          ti_ink            = { read_only = false },
          ti_finishedinking = { read_only = false },
          ti_inknext        = { read_only = false },
          ti_interrupted    = { read_only = false },
          ti_noinks         = { read_only = false },
          ti_inking         = { read_only = false, other_fields = true },
      }
    }
  }
}

files["raw-svo.elistsorter.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "actionclear", "actionfinished", "actions", "actions_performed",
        ...
        "valid_sync_action", "version", "vm", "wait_tbl", "watch",
        "will_take_balance", "newbals", "echon",
          es_capture       = { read_only = false },
          es_appendrequest = { read_only = false },
          es_refillfromkeg = { read_only = false },
          es_captured      = { read_only = false },
          es_dodisposing   = { read_only = false },
          es_dispose       = { read_only = false },
          es_capturing     = { read_only = false },
          es_version       = { read_only = false },
          es_vials         = { read_only = false, other_fields = true },
          es_potions       = { read_only = false, other_fields = true },
          es_knownstuff    = { read_only = false, other_fields = true },
          es_categories    = { read_only = false, other_fields = true },
          es_shortnames    = { read_only = false, other_fields = true },
          es_shortnamesr   = { read_only = false, other_fields = true },
          es_disposecmd    = { read_only = false, other_fields = true },
          signals          = { read_only = false, other_fields = true },
      }
    }
  }
...
files["raw-svo.priestlimbcounter.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "actionclear", "actionfinished", "actions", "actions_performed",
        ...
        "updateaffcount", "updateloggingconfig", "usingbal", "vaff", "valid",
        "valid_sync_action", "version", "vm", "wait_tbl", "watch",
        "will_take_balance", "newbals",
          lasthit           = { read_only = false },
          pl_limbs          = { read_only = false },
          pl_last_endurance = { read_only = false },
          pl_version        = { read_only = false },
          pl_prep_at        = { read_only = false },
          pl_break_at       = { read_only = false },
          pl_hit            = { read_only = false },
          pl_show           = { read_only = false },
          pl_reset          = { read_only = false },
          pl_sethitsneeded  = { read_only = false },
          pl_synchits       = { read_only = false },
          pl_ignore         = { read_only = false },
          pl_smash          = { read_only = false },
          pl_had_balance    = { read_only = false },
          pl_list           = { read_only = false, other_fields = true },
...
files["raw-svo.monklimbcounter.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "actionclear", "actionfinished", "actions", "actions_performed",
        ...
        "will_take_balance", "newbals",
          lasthit           = { read_only = false },
          ml_limbs          = { read_only = false },
          ml_last_endurance = { read_only = false },
          ml_version        = { read_only = false },
          ml_prep_at        = { read_only = false },
          ml_break_at       = { read_only = false },
          ml_hit            = { read_only = false },
          ml_show           = { read_only = false },
          ml_reset          = { read_only = false },
          ml_sethitsneeded  = { read_only = false },
          ml_synchits       = { read_only = false },
          ml_ignore         = { read_only = false },
          ml_had_balance    = { read_only = false },
          ml_list           = { read_only = false, other_fields = true },
          sk                = { read_only = false, other_fields = true },
      }
    }
  }
...
files["raw-svo.metalimbcounter.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "actionclear", "actionfinished", "actions", "actions_performed",
...
files["raw-svo.magilimbcounter.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "actionclear", "actionfinished", "actions", "actions_performed",
...
files["raw-svo.knightlimbcounter.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "actionclear", "actionfinished", "actions", "actions_performed",
        ...
        "will_take_balance", "newbals",
          lasthit           = { read_only = false },
          kl_last_endurance = { read_only = false },
          kl_version        = { read_only = false },
          kl_prep_at        = { read_only = false },
          kl_break_at       = { read_only = false },
          kl_hit            = { read_only = false },
          kl_show           = { read_only = false },
          kl_reset          = { read_only = false },
          kl_sethitsneeded  = { read_only = false },
          kl_synchits       = { read_only = false },
          kl_ignore         = { read_only = false },
          kl_had_balance         = { read_only = false },
          kl_list           = { read_only = false, other_fields = true },
          sk                = { read_only = false, other_fields = true },
      }
    }
  }
...
files["raw-svo.dragonlimbcounter.lua"] = {
  read_globals = {
    "mmp",
    svo = {
      fields = {
        ...
        "will_take_balance",
          lasthit     = { read_only = false },
          dl_version  = { read_only = false },
          dl_prep_at  = { read_only = false },
          dl_break_at = { read_only = false },
          dl_hit      = { read_only = false },
          dl_show     = { read_only = false },
          dl_reset    = { read_only = false },
          dl_ignore   = { read_only = false },
          dl_list     = { read_only = false, other_fields = true },
          sk          = { read_only = false, other_fields = true },
      }
    }
  }
  ...
  read_globals = {
    ...
    svo = {
      fields = {
        ...
        "will_take_balance",
          lasthit     = { read_only = false },
          bl_count    = { read_only = false },
          bl_ignore   = { read_only = false },
          bl_reset    = { read_only = false },
          bl_show     = { read_only = false },
          sk          = { read_only = false, other_fields = true },
          bl_list     = { read_only = false, other_fields = true },
          burn_levels = { read_only = false, other_fields = true },
      }
    }
  }
}

files["raw-svo.peopletracker.lua"] = {
  read_globals = {
    "mmp",
    svo = {
      fields = {
...
files["raw-svo.serverside.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "assert", "haveskillset", "sys", "defdefup", "defkeepup", "signals",
        "deepcopy", "conf", "sk", "me", "defs", "defc", "defences", "stats",
        "empty", "cnrl", "rift", "bals", "doingaction", "usingbal",
        "serverignore", "ignore", "getHighestKey", "doaction",
        "dict_purgative", "dict_salve_def", "dict_herb", "dict_misc",
        "dict_misc_def", "dict_smoke_def", "dict_balanceful",
        "dict_balanceful_def", "dict_balanceless", "dict_balanceless_def",
        "index_map", "getBoundary", "debugf", "valid", "pl", "oldsend",
        "echof", "affsp", "actions", "actionfinished", "actionclear",
        "paragraph_length", "make_gnomes_work", "check_dofree",
        "will_take_balance", "fancysend", "fancysendall", "bals_in_use",
        "concatand", "mm_create_riftlabel", "getDefaultColor", "syncdelay",
        "checkaction", "find_until_last_paragraph", "ignore_illusion",
        "rmaff", "codepaste", "echoafftime", "startbalancewatch",
        "endbalancewatch", "app", "config", "wait_tbl", "doaddfree",
        "getDefaultColorNums", "prompttrigger", "itf", "defdefup",
        "defkeepup", "signals", "deepcopy", "rmaff", "apply", "lostbal_salve",
        "getHighestKey", "lostbal_herb", "eat", "me", "defs", "defences",
        "doingaction", "enabledclasses", "paragraph_length",
        "make_gnomes_work", "lostbal_purgative", "lostbal_focus",
        "lostbal_sip", "empty", "lostbal_healing", "lostbal_moss",
        "find_until_last_paragraph", "echof", "debugf", "lostbal_tree",
        "haveskillset", "sip", "doaction", "killaction", "checkany",
        "lostbal_smoke", "updateaffcount", "addaffdict", "oneconcatwithval",
        "can_usemana", "getping", "lostbal_voice", "lostbal_rage",
        "lostbal_fitness", "fullstats", "shrugging", "lostbal_shrugging",
        "usingbal", "check_generics", "reset", "sendcuring",
        "ignore_illusion", "fitness",  "containsbyname", "assert",
        "defs_data", "concatand", "prio", "enabledskills", "show_info",
        "donext", "findbybal", "send_in_the_gnomes", "bals_in_use",
        "gettreeableaffs", "endbalancewatch", "valid", "tree", "restore",
        "dragonheal", "lostbal_dragonheal", "process_defs",
        "check_sp_satisfied", "sp_config", "will_take_balance", "lastlit",
        "fillpipe", "pflags", "pl", "syncdelay", "sendc", "config", "rage",
        "lostbal_herb", "affs", "rmaff", "dict", "deepcopy", "debugf",
        "defences", "rmaff", "version", "pl", "phpTable", "ripairs", "affs",
        "balanceless", "cp", "cpp", "defences", "lifevision", "signals",
        "sys", "conf", "config", "defc", "defs", "dragonheal", "lifep",
        "lifevision", "paragraph_length", "restore", "shrugging", "sp",
        "sp_config", "stats", "tree", "rage", "fitness", "valid", "watch",
        "gaffl", "gdefc", "actions", "sk", "vm", "cn", "cnrl", "prio",
        "reset", "affl", "serverignore", "ignore", "dict", "me",
        "knownskills", "haveskillset", "logging_in", "dont_unpause_login",
        "danaeusaffs", "nemesisaffs", "scragaffs", "index_map",
        "lastpromptnumber", "promptcount", "send", "pipes", "affsp", "rift",
        "install", "echosd", "echos", "life", "pflags", "paragraph_length",
        "es_categories", "es_shortnames", "es_shortnamesr", "es_potions",
        "es_categories", "assert", "deepcopy", "tablesave", "sps", "defdefup",
        "defkeepup", "empty", "defupfinish", "bottomprompt", "showprompt",
        "make_prio_table", "errorf", "echofn", "make_sync_prio_table", "inra",
        "intlen", "update", "aiprompt", "deleteLineP", "setignore",
        "actions_performed", "sp_limbs", "sp_checksp",
        "count_until_last_paragraph", "findbybals", "vaff", "convert_string",
        "green", "swapped_asthma", "prio_swap", "updateloggingconfig",
        "keystolist", "longeststring", "contains", "oneconcat",
        "setdefaultprompt", "riftlabel", "setupserverside",
        "conf_printinstallhint", "pipe_assignid", "unsetignore",
        "unsetserverignore", "setserverignore", "dict_setup", "dict_validate",
        "ofs", "make_sync_prio_table", "make_prio_table", "valid_sync_action",
        "basictableindexdiff", "clear_sync_prios", "clear_balance_prios",
        "deleteAllP", "addbalanceful", "addbalanceless", "safeconcat", "red",
        "sacid", "make_prio_tablef", "make_sync_prio_tablef", "systemloaded",
        "force_send", "tntf_set",
          shouldignoreserverside = { read_only = false },
          setupserverside        = { read_only = false },
          hitcuringsetlimit      = { read_only = false },
          hitaliaslimit          = { read_only = false },
          serversidesetup        = { read_only = false },
          sk                     = { read_only = false, other_fields = true },
      }
    }
  }
...
files["raw-svo.customprompt.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "assert", "haveskillset", "sys", "defdefup", "defkeepup", "signals",
        ...
        "deleteAllP", "addbalanceful", "addbalanceless", "safeconcat", "red",
        "sacid",
          ingameprompt = { read_only = false },
          cp           = { read_only = false, other_fields = true },
          cpp          = { read_only = false, other_fields = true },
      }
    }
  }
}

files["raw-svo.dor.lua"] = {
  read_globals = {
    svo = {
      fields = {
        ...
        "version", "pl", "phpTable", "ripairs", "affs", "balanceless", "cp", "cpp", "defences", "lifevision", "signals",
         ...
         "es_potions", "es_categories", "assert", "deepcopy", "tablesave", "sps", "defdefup", "defkeepup", "empty",
          ...
          "unsetignore", "unsetserverignore", "setserverignore", "dict_setup", "dict_validate", "ofs",
          "make_sync_prio_table", "make_prio_table", "valid_sync_action", "basictableindexdiff", "clear_sync_prios",
          "clear_balance_prios", "deleteAllP", "addbalanceful", "addbalanceless", "safeconcat", "red",
          me            = { read_only = false, other_fields = true },
          sk            = { read_only = false, other_fields = true },
          sys           = { read_only = false, other_fields = true },
          check_dofree  = { read_only = false },
          donext        = { read_only = false },
          dofirst       = { read_only = false },
          dofreefirst   = { read_only = false },
          doadd         = { read_only = false },
          doaddfree     = { read_only = false },
          dor           = { read_only = false },
          undo          = { read_only = false },
          undofree      = { read_only = false },
          undoall       = { read_only = false },
          undoallfree   = { read_only = false },
          doshow        = { read_only = false },
          doworking     = { read_only = false },
          dofreeworking = { read_only = false },
      }
    }
  }
}

files["raw-svo.funnies.lua"] = {
  read_globals = {
    svo = {
      fields = {
        "assert", "haveskillset", "sys", "defdefup", "defkeepup", "signals", "deepcopy", "conf", "sk", "me", "defs", "defc", "defences", "stats", "empty", "cnrl", "rift", "bals",
        ...
        "version", "pl", "phpTable", "ripairs", "affs", "balanceless", "cp", "cpp", "defences", "lifevision", "signals",
         ...
         "es_potions", "es_categories", "assert", "deepcopy", "tablesave", "sps", "defdefup", "defkeepup", "empty",
          ...
          "unsetignore", "unsetserverignore", "setserverignore", "dict_setup", "dict_validate", "ofs",
          "make_sync_prio_table", "make_prio_table", "valid_sync_action", "basictableindexdiff", "clear_sync_prios",
          "clear_balance_prios", "deleteAllP",
          life    = { read_only = false, other_fields = true },
          lifep   = { read_only = false, other_fields = true },
          protips = { read_only = false, other_fields = true },
      }
    }
  }
}

files["raw-svo.sp.lua"] = {
  read_globals = {
      ...
      fields = {
        ...
        "version", "pl", "phpTable", "ripairs", "affs", "balanceless", "cp", "cpp", "defences", "lifevision", "signals",
         ...
         "es_potions", "es_categories", "assert", "deepcopy", "tablesave", "sps", "defdefup", "defkeepup", "empty",
          ...
          "make_sync_prio_table", "make_prio_table", "valid_sync_action", "basictableindexdiff", "clear_sync_prios",
          "clear_balance_prios",
          checkcustomparry   = { read_only = false },
          check_sp_satisfied = { read_only = false },
          sp_setparry        = { read_only = false },
          sp_checksp         = { read_only = false },
          sp                 = { read_only = false, other_fields = true },
          me                 = { read_only = false, other_fields = true },
          sys                = { read_only = false, other_fields = true },
          sps                = { read_only = false, other_fields = true },
          sp_config          = { read_only = false, other_fields = true },
          sp_limbs           = { read_only = false, other_fields = true },
      }
    }
  }
}

files["raw-svo.prio.lua"] = {
  read_globals = {
    createLabel = { read_only = false },
    "Logger",
    ndb = { read_only = false, other_fields = true },
      ...
      fields = {
        ...
        "version", "pl", "phpTable", "ripairs", "affs", "balanceless", "cp", "cpp", "defences", "lifevision", "signals",
         ...
         "es_potions", "es_categories", "assert", "deepcopy", "tablesave", "sps", "defdefup", "defkeepup", "empty",
          ...
          "make_sync_prio_table", "make_prio_table", "valid_sync_action", "basictableindexdiff", "clear_sync_prios",
          "clear_balance_prios",
          prio              = { read_only = false, other_fields = true },
      ...
      fields = {
        ...
        "version", "pl", "phpTable", "ripairs", "affs", "balanceless", "cp", "cpp", "defences", "lifevision", "signals",
         ...
         "es_potions", "es_categories", "assert", "deepcopy", "tablesave", "sps", "defdefup", "defkeepup", "empty",
          ...
          defupfinish       = { read_only = false },
          defupcancel       = { read_only = false },
          show_current_defs = { read_only = false },
          show_defup        = { read_only = false },
          show_keepup       = { read_only = false },
          ignoreskill       = { read_only = false },
          showhidelist      = { read_only = false },
          process_defs      = { read_only = false },
          create_defmode    = { read_only = false },
          copy_defmode      = { read_only = false },
          rename_defmode    = { read_only = false },
          delete_defmode    = { read_only = false },
          defload           = { read_only = false },
          detect_lifevision = { read_only = false },
          rift              = { read_only = false, other_fields = true },
          install           = { read_only = false, other_fields = true },
          defences          = { read_only = false, other_fields = true },
          defs_data         = { read_only = false, other_fields = true },
          defs              = { read_only = false, other_fields = true },
          defdefup          = { read_only = false, other_fields = true },
          defkeepup         = { read_only = false, other_fields = true },
          ...
          bals_in_use       = { read_only = false, other_fields = true },
          actions_performed = { read_only = false, other_fields = true },
          defc              = { read_only = false, other_fields = true },
          sps               = { read_only = false, other_fields = true },
      ...
      fields = {
        ...
        "version", "pl", "phpTable", "ripairs", "affs", "balanceless", "cp", "cpp", "defences", "lifevision", "signals",
         ...
         "es_potions", "es_categories", "assert", "deepcopy", "tablesave", "sps", "defdefup", "defkeepup", "empty",
          ...
          "swapped_asthma", "prio_swap", "updateloggingconfig", "keystolist", "longeststring", "contains",
          "oneconcat", "setdefaultprompt", "riftlabel", "setupserverside", "conf_printinstallhint", "pipe_assignid",
          "unsetignore", "unsetserverignore", "setserverignore",
          actions                 = { read_only = false },
          transmute               = { read_only = false },
          togglesip               = { read_only = false },
          aupdate                 = { read_only = false },
          toggle_ignore           = { read_only = false },
          show_ignore             = { read_only = false },
          aconfigs                = { read_only = false },
          aconfig                 = { read_only = false },
          aconfig2                = { read_only = false },
          viewmetadefs            = { read_only = false },
          asave                   = { read_only = false },
          ashow                   = { read_only = false },
          showaffs                = { read_only = false },
          showbals                = { read_only = false },
          showserverside          = { read_only = false },
          enableallserverside     = { read_only = false },
          enabledefaultserverside = { read_only = false },
          showcurelist            = { read_only = false },
          app                     = { read_only = false },
          dop                     = { read_only = false },
          dv                      = { read_only = false },
          inra                    = { read_only = false },
          get_herbs               = { read_only = false },
          adf                     = { read_only = false },
          manualdef               = { read_only = false },
          manualdiag              = { read_only = false },
          affsp                   = { read_only = false },
          reset                   = { read_only = false, other_fields = true },
          me                      = { read_only = false, other_fields = true },
          sys                     = { read_only = false, other_fields = true },
          ignorelist              = { read_only = false },
          afflist                 = { read_only = false },
          adddefinition           = { read_only = false },
          vaff                    = { read_only = false },
          vrmaff                  = { read_only = false },
  ...
  read_globals = {
    ...
    svo = {
      fields = {
        ...
        ofs                        = { read_only = false, other_fields = true },
        sk = {
          read_only = true,
          fields = {
            checkrewield              = { read_only = false },
